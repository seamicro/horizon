...
from openstack_dashboard.dashboards.project.bare_metal import tables
from openstack_dashboard.dashboards.project.bare_metal import tabs
from openstack_dashboard.dashboards.project.bare_metal import workflows


INDEX_URL = reverse('horizon:project:bare_metal:index')
...
class InstanceTests(test.TestCase):
    ...
    def test_index_server_list_exception(self):
        ...
        self.assertTemplateUsed(res, 'project/bare_metal/index.html')
