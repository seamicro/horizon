...
from openstack_dashboard.dashboards.project.bare_metal \
...
class IndexView(tables.DataTableView):
    ...
    template_name = 'project/bare_metal/index.html'
    ...
    def get_data(self):
        ...
        # Gather our bare_metal
        try:
            instances, self._more = api.ironic.nodes(
                self.request,
...
class LaunchInstanceView(workflows.WorkflowView):
    workflow_class = project_workflows.ProvisionServer
...
def vnc(request, instance_id):
    try:
        ...
        redirect = reverse("horizon:project:bare_metal:index")
...
class ProvisionServerView(workflows.WorkflowView):
	...
	return api.ironic.server_get(instance_id)
...
class RebuildView(forms.ModalFormView):
    ...
    template_name = 'project/bare_metal/rebuild.html'
    success_url = reverse_lazy('horizon:project:bare_metal:index')
...
class DetailView(tabs.TabView):
    ...
    template_name = 'project/bare_metal/detail.html'
    ...
    def get_data(self):
        if not hasattr(self, "_instance"):
            try:
                instance_id = self.kwargs['instance_id']
                instance = api.ironic.server_get(self.request, instance_id)
