...
#                               help_text=_("Size of image to launch."))
    ...
    class Meta:
        name = _("Details")
        help_text_template = ("project/bare_metal/"
    ...
    network = forms.IntegerField(label=_("VLAN"),
                                        ...
                                        error_messages={
                                            'required': _(
                                                ...
                                                " be specified.")},
                                        help_text=_("Start server with this VLAN"
                                                    " on NIC 0."))
...
class LaunchInstance(workflows.Workflow):
    ...
    finalize_button_name = _("Go")
    success_message = _('Started provisioning of "%(name)s".')
    failure_message = _('Unable to start provisioning "%(name)s".')
    success_url = "horizon:project:bare_metal:index"
